...
$total_deaths   = mysqli_query($koneksi, "SELECT total FROM tb_tdeaths");
?>
...
<head>
	<title>Bar Doughnut Total Deaths</title>
...
<script  type="text/javascript">
  ...
  var data = {
            ...
            {
              label: "Total Deaths",
              data: [<?php while ($p = mysqli_fetch_array($total_deaths)) { echo '"' . $p['total'] . '",';}?>],
              backgroundColor: [
              'rgb(255, 0, 0)',
			  'rgb(255, 255, 0)',
			  'rgb(34, 139, 35)',
