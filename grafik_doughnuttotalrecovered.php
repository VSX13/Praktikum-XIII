...
$total_recovered   = mysqli_query($koneksi, "SELECT total FROM tb_trecovered");
?>
...
<head>
	<title>Bar Doughnut Total Recovered</title>
...
<script  type="text/javascript">
  ...
  var data = {
            ...
            datasets: [
            {
              ...
              data: [<?php while ($p = mysqli_fetch_array($total_recovered)) { echo '"' . $p['total'] . '",';}?>],
              backgroundColor: [
              'rgb(255, 0, 0)',
			  'rgb(255, 255, 0)',
			  'rgb(34, 139, 35)',
