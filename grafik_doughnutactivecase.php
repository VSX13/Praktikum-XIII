...
$active_case   = mysqli_query($koneksi, "SELECT active FROM tb_acase");
?>
...
<head>
	<title>Bar Doughnut Active Case</title>
...
<script  type="text/javascript">
  ...
  var data = {
            ...
            {
              label: "Active Case",
              data: [<?php while ($p = mysqli_fetch_array($active_case)) { echo '"' . $p['active'] . '",';}?>],
              backgroundColor: [
              'rgb(255, 0, 0)',
			  'rgb(255, 255, 0)',
			  'rgb(34, 139, 35)',
