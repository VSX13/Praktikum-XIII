...
$total_case   = mysqli_query($koneksi, "SELECT total FROM tb_tcase");
?>
...
<head>
	<title>Bar Doughnut Total Case</title>
...
<script  type="text/javascript">
  ...
  var data = {
            ...
            {
              label: "Total Case",
              data: [<?php while ($p = mysqli_fetch_array($total_case)) { echo '"' . $p['total'] . '",';}?>],
              backgroundColor: [
              'rgb(255, 0, 0)',
			  'rgb(255, 255, 0)',
			  'rgb(34, 139, 35)',
